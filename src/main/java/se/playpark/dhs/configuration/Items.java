...
public class Items {
    ...
    public static ItemStack HIDER_HELM, SEEKER_HELM,
    ...
    private static PotionEffect getPotionEffect(ConfigurationSection item) {
        ...
        if (type == null)
            return null;
        if (PotionEffectType.getByName(type.toUpperCase()) == null)
            return null;
    ...
    private static boolean equals(ItemStack a, ItemStack b) {
        if (a == null || b == null) {
            ...
            return a.getType() == b.getType() && a.hasItemMeta() == b.hasItemMeta()
                    && (!a.hasItemMeta() || Bukkit.getItemFactory().equals(a.getItemMeta(), b.getItemMeta()));
        }
    }

        ...
        Main.getInstance().getServer().getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            ...
            message = message
                    + String.format("%sTOTAL WINS: %s%s\n%sHIDER WINS: %s%s\n%sSEEKER WINS: %s%s\n%sGAMES PLAYED: %s",
                            ChatColor.YELLOW, ChatColor.WHITE, info.getSeekerWins() + info.getHiderWins(),
                            ChatColor.GOLD, ChatColor.WHITE, info.getHiderWins(),
                            ChatColor.RED, ChatColor.WHITE, info.getSeekerWins(), ChatColor.WHITE,
                            info.getSeekerGames() + info.getHiderGames());

...
import se.playpark.dhs.database.connections.DatabaseConnection;
import se.playpark.dhs.database.connections.MySQLConnection;
import se.playpark.dhs.database.connections.SQLiteConnection;
            ...
            if (legacyTable.copyData()) {
                if (!legacyTable.drop()) {
                    Main.getInstance().getLogger()
                            .severe("Failed to drop old legacy table: player_info. Some data may be duplicated!");
                }
            }
        }
    }
